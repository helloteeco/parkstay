...
import { parks, states, getParksForState, searchParks } from '@/lib/parkData';
          ...
          <div>
            ...
            {filteredParks.length > 0 ? (
              ...
              <div className="text-center py-20 bg-white rounded-xl border border-[#e5e3da]">
                ...
                <h3 className="font-serif text-xl font-semibold text-[#2b2823] mb-2">No destinations found</h3>
