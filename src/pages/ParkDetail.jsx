...
import { ArrowLeft, Star, MapPin, Calendar, Users, Home, Thermometer, Mountain, TreePine, Camera, Fish, Tent, Bike, Sun, ArrowRight } from 'lucide-react';
import { toast } from 'sonner';
import Navbar from '../components/Navbar.jsx';
import Footer from '../components/Footer.jsx';
import { getParkById } from '../data/parkData.js';
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-2xl font-semibold text-[#2b2823] mb-2" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Park not found</h1>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-10">
          <Link to="/explore" className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 text-sm text-[#2b2823] no-underline hover:bg-white transition-colors shadow-sm">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="container">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>
              {park.name}
            </h1>
      ...
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10">
          ...
          <div className="space-y-10">
            <section>
              <h2 className="text-2xl font-semibold text-[#2b2823] mb-4" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>About {park.name}</h2>
              <p className="text-[#787060] leading-relaxed text-base">{park.description}</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[#2b2823] mb-4" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Top Highlights</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2b2823] mb-4" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Things to Do</h2>
            ...
            <section>
              <div className="flex items-end justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-semibold text-[#2b2823]" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Stays Near {park.name}</h2>
                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <h4 className="text-base font-semibold text-[#2b2823]" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>{stay.name}</h4>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border border-[#e5e3da] p-6 sticky top-24 shadow-sm">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-2xl font-bold text-[#2b2823]" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>${park.priceFrom}</span>
            ...
            <div className="bg-white rounded-xl border border-[#e5e3da] p-6">
              <h3 className="text-lg font-semibold text-[#2b2823] mb-4" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Quick Info</h3>
            ...
            <div className="bg-white rounded-xl border border-[#e5e3da] p-6">
              <h3 className="text-lg font-semibold text-[#2b2823] mb-3" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>Nearby Parks</h3>
