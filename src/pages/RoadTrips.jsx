...
*/
import { ArrowRight, Clock, MapPin, Car, Star, Calendar } from 'lucide-react';
import { toast } from 'sonner';
import Navbar from '../components/Navbar.jsx';
import Footer from '../components/Footer.jsx';
import { FAMILY_IMAGE } from '../data/parkData.js';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[45vh] md:h-[55vh] overflow-hidden">
        <img src={FAMILY_IMAGE} alt="Family hiking" className="w-full h-full object-cover" />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="container">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>
              Curated Road Trips
            </h1>
              ...
              >
                <div className={`grid grid-cols-1 lg:grid-cols-[400px_1fr] ${i % 2 === 1 ? 'lg:grid-cols-[1fr_400px]' : ''}`}>
                  ...
                  <div className="p-6 md:p-8 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-semibold text-[#2b2823] mb-1" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>
                      {trip.name}
                    </h2>
      ...
      <section className="py-16 md:py-20 bg-[#2b2823] text-[#e5e3da]">
        <div className="container text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold mb-4" style={{ fontFamily: "'Source Serif 4', Georgia, serif" }}>
